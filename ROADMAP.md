...
- `claude/frontmatter` extractor → `per-node-key-values` showing parsed frontmatter in inspector body.
...
| 8 | Built-in adopter list at landing | Two only: `claude/frontmatter`, `core/external-url-counter`. |
