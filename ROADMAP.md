...
○  10e  Phase G polish               sm-run-queue skill + sm agent install/uninstall/status (in flight) · UI install button (activity-hooks pattern) · github-enrichment plugin · MCP queue-aware deferred to the UI arc · (extension-mode-routing ✅)
