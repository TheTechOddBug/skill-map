...
○  10e  Phase G polish               sm-run-queue skill + sm agent verbs ✅ · HTTP + Settings install button (tri-state) ✅ · github-enrichment plugin (last piece) · MCP queue-aware deferred to the UI arc · (extension-mode-routing ✅)
