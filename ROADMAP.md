...
- Fixers via Modelo B: `precondition.analyzerIds` joins fixer Actions to finders; prose fixes execute in the draining agent's own session (no new write surface, see `spec/architecture.md` §Modelo B).
