...
description: Skill de ejemplo número tres; formatea el reporte final de la cadena demo envolviendo los marcadores recibidos. La sigue el workflow demo-flow para cerrar la cadena (marcador 📋).
---
