...
Demonstrator skill that touches every documented frontmatter field on `skill-base.schema.json`. Supersedes #superseded-skill. Pairs with @full-agent-claude (the agent half) and /full-command-claude (the command half).
