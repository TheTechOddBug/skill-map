...
4. Invocar `/demo-skill-one` y emitir también su marcador (la invocación se ejecuta con el tool Skill, skill: `demo-skill-one`; demuestra skill→skill).
