...
import { renderBanner, resolveColorEnabled } from '../serve-banner.js';
...
describe('serve banner, non-TTY (piped / redirected)', () => {
  it('falls back to the two-line legacy format under --open', () => {
    ...
    assert.ok(
      out.includes('sm serve: listening on http://127.0.0.1:4242 (db=/projects/skill-map/.skill-map/skill-map.db)'),
