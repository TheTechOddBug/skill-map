 ...
 * it (`sm plugins disable core/ai-incoherence-action`) to drop it as a submit
 * target.
 */
...
export const aiIncoherenceAction: IBuiltInManifest<IAction> = {
  ...
  kind: 'action',
  description:
    'Fixes the gaps a review found: fills in missing references, makes terms consistent, and puts steps in order, without inventing anything.',
