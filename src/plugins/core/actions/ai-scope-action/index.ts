/**
 * Built-in probabilistic `ai-scope-action` Action, the fixer paired with
 * the `core/ai-scope-analyzer` finder (Modelo B, one of the five
 * OPTIMIZATION pairs, 2026-07-22). Resolves that finder's `scope`
...
export const aiScopeAction: IBuiltInManifest<IAction> = {
  id: 'ai-scope-action',
  pluginId: PLUGIN_ID,
  kind: 'action',
  description:
