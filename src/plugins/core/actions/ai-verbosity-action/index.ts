/**
 * Built-in probabilistic `ai-verbosity-action` Action, the fixer paired with
 * the `core/ai-verbosity-analyzer` finder (Modelo B, one of the five
 * OPTIMIZATION pairs, 2026-07-22). Resolves that finder's `verbosity`
...
export const aiVerbosityAction: IBuiltInManifest<IAction> = {
  id: 'ai-verbosity-action',
  pluginId: PLUGIN_ID,
  kind: 'action',
  description:
