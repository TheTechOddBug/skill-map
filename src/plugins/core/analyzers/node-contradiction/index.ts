 ...
 * queued job (`sm jobs submit node-contradiction -n <node>`), an external
 ...
 * opts in (`sm plugins enable core/node-contradiction`) before the
...
export const nodeContradictionAnalyzer: IBuiltInManifest<IAnalyzer> = {
