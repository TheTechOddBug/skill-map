/**
 * Built-in probabilistic `ai-vagueness-analyzer` Analyzer, one of the five
 ...
 * pairs). Judges ONE node for vagueness (imprecision). Its judgments land in
 * `state_findings` as `type: 'vagueness'` rows (advisory, never
...
export const aiVaguenessAnalyzer: IBuiltInManifest<IAnalyzer> = {
  id: 'ai-vagueness-analyzer',
  pluginId: PLUGIN_ID,
  kind: 'analyzer',
  description:
