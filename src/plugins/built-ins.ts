...
const claudeProvider = { ..._claudeProvider, pluginId: 'claude', version: '0.42.0' };
const atDirectiveExtractor = { ..._atDirectiveExtractor, pluginId: 'claude', version: '0.42.0' };
const slashCommandExtractor = { ..._slashCommandExtractor, pluginId: 'claude', version: '0.42.0' };
const antigravityProvider = { ..._antigravityProvider, pluginId: 'antigravity', version: '0.42.0' };
const openaiProvider = { ..._openaiProvider, pluginId: 'openai', version: '0.42.0' };
const agentSkillsProvider = { ..._agentSkillsProvider, pluginId: 'agent-skills', version: '0.42.0' };
const coreMarkdownProvider = { ..._coreMarkdownProvider, pluginId: 'core', version: '0.42.0' };
const annotationsExtractor = { ..._annotationsExtractor, pluginId: 'core', version: '0.42.0' };
const externalUrlCounterExtractor = { ..._externalUrlCounterExtractor, pluginId: 'core', version: '0.42.0' };
const markdownLinkExtractor = { ..._markdownLinkExtractor, pluginId: 'core', version: '0.42.0' };
const mcpToolsExtractor = { ..._mcpToolsExtractor, pluginId: 'core', version: '0.42.0' };
const toolsCounterExtractor = { ..._toolsCounterExtractor, pluginId: 'core', version: '0.42.0' };
const annotationFieldUnknownAnalyzer = { ..._annotationFieldUnknownAnalyzer, pluginId: 'core', version: '0.42.0' };
const annotationOrphanAnalyzer = { ..._annotationOrphanAnalyzer, pluginId: 'core', version: '0.42.0' };
const annotationStaleAnalyzer = { ..._annotationStaleAnalyzer, pluginId: 'core', version: '0.42.0' };
const contributionOrphanAnalyzer = { ..._contributionOrphanAnalyzer, pluginId: 'core', version: '0.42.0' };
const issueCounterAnalyzer = { ..._issueCounterAnalyzer, pluginId: 'core', version: '0.42.0' };
const jobFileOrphanAnalyzer = { ..._jobFileOrphanAnalyzer, pluginId: 'core', version: '0.42.0' };
const linkConflictAnalyzer = { ..._linkConflictAnalyzer, pluginId: 'core', version: '0.42.0' };
const linkCounterAnalyzer = { ..._linkCounterAnalyzer, pluginId: 'core', version: '0.42.0' };
const linkSelfLoopAnalyzer = { ..._linkSelfLoopAnalyzer, pluginId: 'core', version: '0.42.0' };
const nameReservedAnalyzer = { ..._nameReservedAnalyzer, pluginId: 'core', version: '0.42.0' };
const nodeStabilityAnalyzer = { ..._nodeStabilityAnalyzer, pluginId: 'core', version: '0.42.0' };
const nodeSupersededAnalyzer = { ..._nodeSupersededAnalyzer, pluginId: 'core', version: '0.42.0' };
const referenceBrokenAnalyzer = { ..._referenceBrokenAnalyzer, pluginId: 'core', version: '0.42.0' };
const referenceRedundantAnalyzer = { ..._referenceRedundantAnalyzer, pluginId: 'core', version: '0.42.0' };
const schemaViolationAnalyzer = { ..._schemaViolationAnalyzer, pluginId: 'core', version: '0.42.0' };
const signalCollisionAnalyzer = { ..._signalCollisionAnalyzer, pluginId: 'core', version: '0.42.0' };
const triggerCollisionAnalyzer = { ..._triggerCollisionAnalyzer, pluginId: 'core', version: '0.42.0' };
const asciiFormatter = { ..._asciiFormatter, pluginId: 'core', version: '0.42.0' };
const jsonFormatter = { ..._jsonFormatter, pluginId: 'core', version: '0.42.0' };
const nodeBumpAction = { ..._nodeBumpAction, pluginId: 'core', version: '0.42.0' };
const nodeSupersedeAction = { ..._nodeSupersedeAction, pluginId: 'core', version: '0.42.0' };
const updateCheckHook = { ..._updateCheckHook, pluginId: 'core', version: '0.42.0' };
