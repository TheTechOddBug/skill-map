  ...
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: '13',  status: 'planned', title: { en: 'Multi-host Providers',            es: 'Providers multi-host' },                    body: { en: 'Copilot · generic Provider (frontmatter-driven fallback) · per-host skill namespace · Provider conformance suite (Codex, Agent Skills and Antigravity already landed)', es: 'Copilot · Provider genérico (fallback por frontmatter) · namespace de skills por host · suite de conformance por Provider (Codex, Agent Skills y Antigravity ya aterrizaron)' } },
        { id: '17',  status: 'planned', title: { en: 'UI: AI surfaces v2 (deeper)',     es: 'UI: superficies AI v2 (más profundo)' },    body: { en: 'Connected AI agents driving the job queue over MCP · settings hierarchy viewer · accessibility (WCAG AA) pass',                     es: 'Agentes AI conectados manejando la cola de jobs vía MCP · visor de jerarquía de settings · pase de accesibilidad (WCAG AA)' } },
