  ...
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'IR',   status: 'done', title: { en: 'Signal IR + collision detection', es: 'Signal IR + detección de colisiones' },   body: { en: 'Extractors emit byte-ranged Signals · the resolver ranks candidates and detects cross-extractor overlaps · core/signal-collision surfaces the losers', es: 'Los extractors emiten Signals con rango de bytes · el resolver rankea candidatos y detecta solapamientos cross-extractor · core/signal-collision muestra a los perdedores' } },
        ...
        { id: 'insp', status: 'done', title: { en: 'Extensible inspector',            es: 'Inspector extensible' },                 body: { en: 'Plugins contribute action buttons and per-plugin sections · parametrized actions (supersede / set stability / edit tags) · the host owns dispatch + consent', es: 'Los plugins aportan botones de acción y secciones por plugin · acciones parametrizadas (supersede / setear estabilidad / editar tags) · el host maneja dispatch + consentimiento' } },
