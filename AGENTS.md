...
|---|---|
| [`context/scripts.md`](./context/scripts.md) | adding / moving / removing npm scripts (root or workspace) and any file under `scripts/` |
