...
| [`context/cli-output-style.md`](./context/cli-output-style.md) | designing or polishing the **human-mode** output of any `sm` verb (glyph catalog, color resolution, layout patterns, plural rules, path display, sanitisation, JSON-contract isolation) |
