 ...
 *
 * The WS subscription that applies `sidecar.bumped` events to the
 * in-memory store moved to `CollectionLoaderService` (see
 * `collection-loader.spec.ts`); the matching test now lives there.
 */
