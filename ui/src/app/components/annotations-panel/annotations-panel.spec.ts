...
/**
 * Step 9.6.5 — `<sm-annotations-panel>` tests. Covers the section-level
 * gating (empty sections collapse), chip rendering for the supersession
 * paths, and stability tag rendering.
 */
...
describe('AnnotationsPanel — section rendering', () => {
  ...
  it('renders tags + keywords chips in the taxonomy section', () => {
    const dom = bootstrap({
      present: true,
      status: 'fresh',
      annotations: {
...
describe('AnnotationsPanel — openPath emission', () => {
  it('emits openPath when a supersedes chip is clicked', () => {
    TestBed.resetTestingModule();
    TestBed.configureTestingModule({});
    const fixture = TestBed.createComponent(AnnotationsPanel);
